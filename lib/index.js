...
(function () {
	...
	DateSelector.prototype = {
		...
		show: function show() {
			...
			this.el.__outsideClickEvent__ = function (e) {
				if (!_this6.el.contains(e.target)) {
					_this6.hide();
				}
			};
			this.el.__backgroundScrollEvent__ = function (e) {
				_this6.showAt();
			};
			setTimeout(function () {
				document.body.addEventListener('click', _this6.el.__outsideClickEvent__);
				document.addEventListener('scroll', _this6.el.__backgroundScrollEvent__);
			});
			this.isshow = true;
		},
		hide: function hide() {
